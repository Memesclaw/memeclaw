...
* **symbol**: e.g., "ALPHA_175USDT" ¨C use token ID from Token List
...
* **interval**: e.g., "1h" ¨C supported intervals: 1s, 15s, 1m, 3m, 5m, 15m, 30m, 1h, 2h, 4h, 6h, 8h, 12h, 1d, 3d, 1w, 1M
...
When listing accounts, show names and environment only ¡ª never keys:
Binance Accounts:
* main (Mainnet)
...
Otherwise, do not perform steps 3¨C5.
